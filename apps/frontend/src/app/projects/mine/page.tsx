...
import { ArrowRight, Folder, Loader2, RefreshCcw, Paperclip, Plus, Archive, Trash2, DollarSign, Users, Tag } from "lucide-react";
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-wrap items-center gap-4 text-sm text-slate-600 mb-4">
            ...
            {project._count?.proposals !== undefined && (
              <div className="flex items-center gap-1.5">
                <Users size={16} />
                <span className="font-semibold">{project._count.proposals} proposals</span>
              </div>
            )}
          </div>
